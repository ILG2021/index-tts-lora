"""Dependency-free guards for trusted IndexTTS2 LoRA resume state."""
...
def verify_resume_checkpoint(
    ...
    *,
    ...
    if document.get("adaptation_mode") != "lora":
        raise ValueError("resume metadata adaptation_mode must equal lora")
...
def evaluator_lora_artifact_paths(checkpoint: Path) -> dict[str, Path]:
